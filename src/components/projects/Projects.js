...
//   <ul className="flex justify-center space-x-8">
//     <li
//       className={`relative p-4 cursor-pointer text-white rounded-lg shadow-lg transition-all duration-500 ease-in-out transform hover:scale-110 hover:rotate-2 
